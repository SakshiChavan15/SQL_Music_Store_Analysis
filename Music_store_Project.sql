...
-- Which city has the best customer? we would like to throw a promotional music festival 
-- in the city we made most of the money. Write a query that returns one city that has highest sum of invoice total.
...
-- Write a query that returns the best person whohas spent the most money.
